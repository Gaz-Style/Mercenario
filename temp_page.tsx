...
export default function Home() {
    ...
    useEffect(() => {
        if (videoRef.current) {
            // Safari mobile strict autoplay overrides
            videoRef.current.defaultMuted = true;
            videoRef.current.muted = true;
            videoRef.current.play().catch(e => console.log("Autoplay blocked:", e));

            // Fallback nuclear: si iOS bloquea absolutametne el autoplay hasta haya interacci├│n,
            // iniciamos el video al primer toque en la pantalla (como al hacer scroll).
            const forcePlay = () => {
    ...
    const projects = [
        { title: "NeuroV", cat: "Inteligencia Artificial & UX", desc: "SaaS m├®dico automatizado para cl├¡nicas est├®ticas.", link: "https://neuro-v.vercel.app/", bg: "bg-neutral-950 border-mercenario-danger/20", image: "/imagenes/ejecutados/neuroV.jpeg" },
        { title: "SocialMotors", cat: "E-commerce & Estrategia", desc: "Plataforma de ventas y embudo de conversi├│n automotriz.", link: "https://www.socialmotors.cl/", bg: "bg-neutral-950 border-white/[0.03]", image: "/imagenes/ejecutados/socialmotors.jpeg" },
        { title: "Valet PRT", cat: "SaaS & Operaciones", desc: "Sistema de gesti├│n y recepci├│n automatizada de veh├¡culos.", link: "https://socialmotors.cl/valet", bg: "bg-neutral-950 border-white/[0.03]", image: "/imagenes/ejecutados/valetPRT.jpeg" },
            ...
            <main className="w-full max-w-6xl mx-auto px-4 sm:px-6 pb-32 z-10 flex flex-col items-center">
                ...
                <section className="text-center max-w-3xl pt-14 md:pt-24 pb-16 space-y-5 flex flex-col items-center relative w-full rounded-2xl overflow-hidden mt-6 border border-white/[0.03]">
                    ...
                    <p className="text-neutral-400 text-xs sm:text-sm max-w-md mx-auto leading-relaxed px-2 font-mono z-10 mt-3 sm:mt-4">
                        Dise├▒amos y escalamos toda tu cadena de ventas con pauta de respuesta directa y arquitectura t├®cnica_
                    </p>
                ...
                <section className="w-full bg-[#000] border-y border-white/[0.02] overflow-hidden relative mt-8 md:mt-16 min-h-[140px] sm:min-h-[160px] flex items-center justify-center">
                    ...
                    {/* Capa Trasera (Back): Oscura, Escala Menor, Gira al Rev├®s */}
                ...
                <section className="w-full max-w-4xl mx-auto px-6 py-16 md:py-24 text-center space-y-6">
                    ...
                    <p className="font-mono text-sm md:text-base text-neutral-400 max-w-2xl mx-auto leading-relaxed">
                        Solo aceptamos proyectos donde exista viabilidad matem├ítica y t├®cnica para multiplicar tu facturaci├│n. Dise├▒amos infraestructura, inyectamos tr├ífico cualificado y automatizamos el cierre de ventas bajo un protocolo de ejecuci├│n hiper-rentable.
                    </p>
                </section>

                {/* 2. PROYECTOS DESTACADOS - CARRUSEL INFINITO FORMATO M├ôVIL */}
                <section className="w-full pt-10 md:pt-16 flex flex-col items-center">
                    <div className="text-center space-y-1 z-10 mb-4 sm:mb-8">
                        ...
                        <p className="text-[10px] sm:text-[11px] text-neutral-600 font-mono">Bit├ícora de despliegues y experiencia m├│vil</p>
                    </div>
                ...
                <section className="w-full pt-20 md:pt-32 max-w-6xl mx-auto px-6">
                    <div className="text-center space-y-4 mb-12 sm:mb-16">
                        <div className="inline-block border border-mercenario-danger/30 bg-mercenario-danger/5 px-4 py-1.5 rounded-full mb-2">
                            <span className="text-[9px] font-mono text-mercenario-danger font-bold uppercase tracking-[0.2em]">Operaci├│n Bandera</span>
                        </div>
                        ...
                        <p className="font-mono text-sm sm:text-base text-neutral-400 max-w-2xl mx-auto leading-relaxed">
                            No solo ejecutamos tareas; instalamos un <strong className="text-white">Cerebro Operativo</strong> en tu empresa. Un flujo continuo pilotado por Inteligencia Artificial y automatizaci├│n dise├▒ado para dominar todo el ciclo de vida del cliente.
                        </p>
                    </div>

                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
                        {[
                            { step: "01", title: "Atracci├│n", desc: "Miner├¡a de leads y pauta inteligente y aut├│noma." },
                            { step: "02", title: "Intercepci├│n", desc: "Agentes SDR 24/7 y perfilamiento algor├¡tmico." },
                            { step: "03", title: "Ingenier├¡a", desc: "Integraci├│n de C├│mputo API y automatizaci├│n CRM." },
                            { step: "04", title: "Cierre", desc: "Redacci├│n din├ímica e hiper-personalizaci├│n." },
                            { step: "05", title: "Retenci├│n", desc: "LTV, gesti├│n de reputaci├│n y recompra autom├ítica." }
                        ].map((s, i) => (
                    ...
                    <div className="mt-12 text-center">
                        <Link href="/ecosistema-360" className="inline-flex items-center gap-2 text-[10px] font-mono font-bold text-mercenario-danger uppercase tracking-widest hover:text-white transition-colors group">
                            <span className="border-b border-mercenario-danger/30 group-hover:border-white/30 pb-0.5 transition-colors">Ver Documentaci├│n Desclasificada del Sistema</span>
                ...
                <section className="w-full space-y-6 md:space-y-10 pt-20 md:pt-32 mt-12 md:mt-20">
                    <div className="text-center space-y-2 px-4 border-t border-white/[0.05] pt-12 md:pt-20">
                        <h2 className="text-xl sm:text-2xl font-black font-mono tracking-wider uppercase text-white">INTERVENCIONES_T├üCTICAS_</h2>
                        <p className="text-[10px] sm:text-[11px] text-neutral-500 font-mono max-w-xl mx-auto leading-relaxed">
                            Respuesta directa bajo arquitectura propia. Contrata el Ecosistema 360 completo o despliega nuestros "Caballos de Troya" para resolver fallas cr├¡ticas en tu maquinaria actual de ventas.
                        </p>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 max-w-6xl mx-auto">
                        {[
                            { num: "01", icon: Target, title: "Pauta T├íctica Integral", desc: "Campa├▒as de respuesta directa multiplataforma en Meta, Google y TikTok Ads.", items: ["CPA & Retorno Directo", "Estructura de Escalabilidad", "Modelado de Atribuci├│n"] },
                            { num: "02", icon: Database, title: "Arquitectura SaaS & Sistemas_", desc: "Dise├▒o y desarrollo de backends escalables, dashboards operativos y CRM a medida.", items: ["Node.js / Python / SQL", "Automatizaci├│n de Procesos", "Infraestructura Cloud"] },
                            { num: "03", icon: Globe, title: "Ingenier├¡a Frontend (Next.js)_", desc: "Construcci├│n de plataformas y aplicativos web de carga ultra-r├ípida.", items: ["Next.js / TypeScript", "Core Web Vitals", "Flujos de Conversi├│n"] },
                            { num: "04", icon: Palette, title: "UX/UI & Dise├▒o de Producto_", desc: "Interfaces comerciales y prototipado que proyectan autoridad y conversi├│n.", items: ["Dise├▒o de Producto", "Branding T├®cnico", "Activos Digitales"] },
                            { num: "05", icon: Video, title: "Producci├│n Audiovisual_", desc: "Grabaci├│n y edici├│n de video de alta retenci├│n para Ads y Reels t├ícticos.", items: ["Corte Din├ímico", "Post-producci├│n", "Formatos Verticales"] },
                            { num: "06", icon: MessageSquare, title: "Creaci├│n de Contenido_", desc: "Estrategia para posicionar marca sin depender solo de tr├ífico pagado.", items: ["Copywriting Directo", "Parrillas Estrat├®gicas", "Guiones de Conversi├│n"] },
                            { num: "07", icon: Mail, title: "Automations & Email Marketing_", desc: "Automatizaci├│n de flujos de nutrici├│n y CRM para cerrar ventas latentes.", items: ["Automatizaci├│n de Env├¡os", "Integraci├│n CRM", "Flujos de Reserva"] },
                            { num: "08", icon: Cpu, title: "Integraci├│n IA & Automations_", desc: "Entrenamiento e integraci├│n de modelos de lenguaje para workflows automatizados.", items: ["Agentes de IA", "Automatizaci├│n Workflows", "API Integrations"] }
                        ].map((serv, i) => (
                ...
                {/* 3.5 INFINITE METRICS STRIP (Framer Motion Marquee) - Reubicado Aqu├¡ */}
                    ...
                    >
                        <div className="flex gap-8 items-center">
                            {[
                                ...
                                "VENTAS: +220% [RETAIL]_", "ROI: 520% [B2B]_", "INDEXACI├ôN: 100% [IA]_"
                            ].map((met, i) => (
                ...
                <section className="w-full space-y-12 mt-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
                        {[
                            { title: "Operaci├│n: Escala E-commerce", client: "Retail Moda", mainMetric: "+250%", metricLabel: "Incremento en Ventas", items: ["Paid Media Multicanal", "Embudo de Alta Conversi├│n", "Atribuci├│n en Tiempo Real"], icon: TrendingUp },
                            { title: "Operaci├│n: Captura B2B", client: "Servicios SaaS", mainMetric: "-35%", metricLabel: "Reducci├│n de CPL", items: ["LinkedIn Ads de Autoridad", "Automatizaci├│n CRM", "AI Bots de Seguimiento"], icon: BarChart },
                            { title: "Operaci├│n: Visibilidad Total", client: "Salud / Cl├¡nicas", mainMetric: "+180%", metricLabel: "Leads Org├ínicos", items: ["SEO Local & Maps", "B├║squeda Generativa IA", "Indexaci├│n Automatizada"], icon: Zap }
                        ].map((caso, i) => (
                ...
                <motion.section id="contacto" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="w-full pt-16 max-w-md mx-auto space-y-6 flex flex-col items-center mt-24">
                    <div className="text-center space-y-1">
                        <h2 className="text-lg font-black font-mono uppercase tracking-wider text-white">EVALUACI├ôN_PROYECTO_</h2>
                        <p className="text-[10px] text-neutral-500 font-mono">Iniciando protocolo de auditor├¡a t├®cnica</p>
                    </div>
                    ...
                    <form onSubmit={handleFormSubmit} className="w-full bg-[#060606] border border-white/[0.04] p-5 sm:p-7 space-y-4 rounded shadow-2xl relative">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                <label className="text-[9px] font-bold text-neutral-500 uppercase tracking-widest font-mono">Inversi├│n Publicitaria / Mes _</label>
                                <select value={formData.budget} onChange={(e) => setFormData({...formData, budget: e.target.value})} className="w-full bg-[#020202] border border-white/5 rounded px-3 py-2.5 text-xs mt-1 focus:outline-none focus:border-mercenario-danger/50 text-gray-400 font-mono transition-colors appearance-none" required disabled={formStatus === "loading" || formStatus === "success"}>
                                    ...
                                    <option value="M├ís de $50.000 USD">+ $50.000 USD / mes</option>
                        ...
                        {formStatus === "error" && (
                            <p className="text-mercenario-danger text-[10px] font-mono mt-2 text-center p-2 border border-mercenario-danger/20 bg-mercenario-danger/5 rounded">Fallo en la comunicaci├│n encriptada. Intenta nuevamente.</p>
                        )}
                        {formStatus === "success" && (
                        ...
                        >
                            {formStatus === "loading" ? "Procesando Datos..." : formStatus === "success" ? "Auditor├¡a Solicitada_" : (
