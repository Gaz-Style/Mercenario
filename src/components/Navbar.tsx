...
export default function Navbar() {
    ...
    const navLinks = [
        { href: '/pilares/erp', label: 'ERP' },
        { href: '/pilares/crm', label: 'CRM' },
        { href: '/pilares/pos', label: 'POS' },
        { href: '/pilares/bi', label: 'BI' },
        { href: '/industrias/gastronomia', label: 'Industrias' },
    ];
        ...
        <>
            <nav className="fixed top-0 w-full z-50 bg-black/20 backdrop-blur-xl border-b border-white/10 transition-all duration-300">
                <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between relative">
                    {/* Left Area: Back Button & Brand Logo */}
                    <div className="flex items-center gap-4">
                        ...
                        <Link href="/" className={`${!isHome ? 'hidden md:flex' : 'flex'} flex-col items-stretch justify-center w-max`}>
                            <div className="flex justify-between w-full font-serif text-2xl md:text-3xl font-black uppercase text-white leading-none drop-shadow-sm tracking-[0.15em]">
                                MERCENARIO
                            </div>
                            <div 
                    ...
                    {!isHome && (
                        <Link href="/" className="flex md:hidden flex-col items-stretch justify-center w-max absolute left-1/2 -translate-x-1/2">
                            <div className="flex justify-between w-full font-serif text-2xl font-black uppercase text-white leading-none drop-shadow-sm gap-1 tracking-[0.15em]">
                                MERCENARIO
                            </div>
                            <div 
                    ...
                    <div className="hidden md:flex items-center gap-8 text-xs uppercase tracking-[0.2em] font-sans text-white/80 font-semibold">
                        ...
                        <Link href="/admin/login" className="glass-btn px-6 py-2.5 border-[0.5px] border-white/20 border-t-white/40 border-l-white/40 border-b-white/10 border-r-white/10 text-white font-sans text-xs uppercase tracking-[0.2em] font-semibold bg-white/[0.08] backdrop-blur-[10px] transition-all duration-[500ms] ease-[cubic-bezier(0.16,1,0.3,1)] hover:bg-[#f5f2eb]/90 hover:text-[#121212] hover:border-[#f5f2eb] hover:shadow-[0_0_15px_rgba(255,255,255,0.1)] rounded-[1px] whitespace-nowrap">
                            Acceder
                        </Link>
                    </div>
