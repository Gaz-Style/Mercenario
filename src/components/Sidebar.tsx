...
export const sidebarItems = [
    { name: 'Mando Central', href: '/admin', icon: LayoutDashboard },
    { name: 'Growth & Marketing', href: '/admin/marketing', icon: LineChart },
    { name: 'Empresas & Licencias', href: '/admin/licenses', icon: Users },
    { name: 'Facturación SaaS', href: '/admin/billing', icon: DollarSign },
    { name: 'Órdenes de Despliegue', href: '/admin/deployments', icon: Package },
    { name: 'Telemetría & Uso', href: '/admin/telemetry', icon: Activity },
    { name: 'Soporte B2B', href: '/admin/support', icon: ShoppingBag },
            ...
            <div className="flex items-center justify-between p-6 border-b border-zinc-100 h-[80px]">
                <AnimatePresence mode="wait">
                    {!isCollapsed && (
                        ...
                        >
                            <span className="font-serif text-xl text-zinc-900 font-bold tracking-tight">Mercenario</span>
            ...
            <div className="p-4 border-t border-zinc-100 bg-zinc-50/50">
                <div className={cn("flex items-center", isCollapsed ? "justify-center" : "gap-3")}>
                    <div className="w-9 h-9 rounded-full bg-zinc-100 flex items-center justify-center flex-shrink-0 border border-zinc-200/60 shadow-sm">
                        <span className="text-[11px] font-serif font-bold text-zinc-700">M</span>
                    </div>
                    {!isCollapsed && (
                        <motion.div 
                            initial={{ opacity: 0 }}
