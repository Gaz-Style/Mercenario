    ...
    return (
        <div className="w-full max-w-xl mx-auto bg-[#0a0a0a] border border-white/[0.1] rounded-lg p-6 sm:p-8 mt-12 font-mono relative overflow-hidden shadow-[0_20px_40px_rgba(0,0,0,0.8)]">
            ...
            <div className="flex items-center gap-2 mb-6 border-b border-white/[0.05] pb-4">
                ...
                <h3 className="text-xs uppercase tracking-widest text-white font-bold">Simulador de Fricción Operativa_</h3>
            </div>
            
            <div className="space-y-6 relative z-10">
                <div>
                    <label className="text-[10px] text-neutral-400 uppercase tracking-widest mb-2 block">Facturación Mensual Estimada (USD)_</label>
                ...
                <div className="grid grid-cols-2 gap-4 pt-4 border-t border-white/[0.05]">
                    <div className="space-y-1">
                        ...
                        <p className="text-[8px] text-neutral-600 leading-tight pt-1">Pérdida por latencia de repuesta, abandono de carrito y nulo seguimiento.</p>
                    </div>
                    <div className="space-y-1 border-l border-white/[0.05] pl-4">
                        <span className="text-[9px] text-emerald-500 uppercase tracking-widest block">Recuperación con IA</span>
                        <span className="text-xl sm:text-2xl font-black text-emerald-500 tracking-tighter">+${(lostRevenue * 0.85).toLocaleString()}</span>
                        <p className="text-[8px] text-neutral-600 leading-tight pt-1">Ingreso bloqueado mediante intercepción automática y remarketing continuo.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <main className="pt-32 pb-24 px-4 sm:px-6 max-w-5xl mx-auto space-y-32 sm:space-y-40 relative z-10">
                ...
                <section className="text-center space-y-8 min-h-[75vh] flex flex-col items-center justify-center relative">
                    ...
                    <p className="text-neutral-400 text-xs sm:text-sm font-mono max-w-2xl leading-relaxed">
                        No gestionamos su marketing. Codificamos su rentabilidad. Desplegamos la infraestructura técnica que rastrea la intención, automatiza la confianza y asegura el cobro de punta a punta.
                    </p>
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-4 pt-6 w-full justify-center">
                        <a href="#auditoria" className="w-full sm:w-auto px-8 py-4 bg-mercenario-danger text-white font-black text-[10px] sm:text-xs uppercase tracking-widest rounded transition-all hover:bg-red-700 font-mono flex items-center justify-center gap-3">
                            [INICIAR PROTOCOLO DE AUDITORÍA] <ChevronRight className="w-4 h-4" />
                        </a>
                ...
                {/* 2. EL DIAGNÓSTICO (La Fricción Humana) */}
                <section className="space-y-12">
                    <div className="text-center space-y-4">
                        ...
                        <p className="text-neutral-400 text-xs sm:text-sm font-mono max-w-2xl mx-auto leading-relaxed">
                            La mayoría de las empresas <strong className="text-red-500 font-bold hidden sm:inline">pierden el 40% de sus ingresos</strong> en el 'limbo' entre el clic y el cobro. El error humano, la demora en la respuesta y la falta de integración matan su LTV (Valor de Vida del Cliente).
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-4xl mx-auto">
                        <div className="p-8 border border-white/[0.05] bg-[#050505] rounded-xl flex flex-col items-center text-center opacity-60">
                            <span className="font-mono text-[10px] text-neutral-500 uppercase tracking-widest mb-6 block">Marketing Tradicional (Desconexión)</span>
                        ...
                        <div className="p-8 border border-mercenario-danger/30 bg-mercenario-danger/5 rounded-xl flex flex-col items-center text-center relative overflow-hidden shadow-[0_0_30px_rgba(255,17,34,0.05)]">
                            ...
                            <div className="flex flex-col w-full max-w-xs relative z-10">
                                <div className="px-4 py-3 bg-white/5 border border-white/10 text-[10px] font-mono text-white rounded-t">Inbound Algorítmico</div>
                                <div className="px-4 py-3 bg-mercenario-danger/20 border-x border-mercenario-danger/30 text-[10px] font-mono text-mercenario-danger font-bold flex items-center justify-center gap-2">
                                    <Zap className="w-3 h-3" /> Intercepción IA (0s latencia)
                                </div>
                ...
                {/* 3. EL NÚCLEO TÉCNICO: "THE REVENUE ENGINE" */}
                <section id="arquitectura" className="space-y-12 pt-10">
                    <div className="text-center space-y-4">
                        ...
                        <p className="text-neutral-500 text-[10px] font-mono uppercase tracking-widest">Desglose de Capacidad de Fuego Técnica</p>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {[
                            { id: "A", title: "EL RADAR (Inteligencia Inbound)", tech: "Algoritmos de predicción + GTM Server Side.", val: "Detectamos la intención de compra antes de que el lead sea un nombre. Personalización dinámica de landings según la patología, modelo de auto o necesidad financiera.", icon: Activity },
                            { id: "B", title: "EL CEREBRO (IA & NLP Operativo)", tech: "Whisper (OpenAI) + NLP de sentimiento.", val: "Intercepción conversacional 24/7. Nuestra IA no 'chatea'; analiza el miedo, la frustración o la urgencia del lead para calificarlo y cerrar la venta.", icon: Brain },
                            { id: "C", title: "LOS RIELES (Integración Crítica)", tech: "Conectividad nativa API (Imed, Fintech, Registros).", val: "Nos conectamos a las arterias de su industria. Cobro automatizado vía pasarela y sincronización con sistemas nacionales de salud o registros legales.", icon: LinkIcon },
                            { id: "D", title: "EL RETORNO (Ingeniería de LTV)", tech: "Cron Jobs + Automatización Inbound.", val: "La venta es el inicio. El sistema programa la fidelización y la recompra de forma predictiva basado en el historial del usuario.", icon: Database }
                        ].map((block, i) => (
                ...
                {/* 4. PRUEBA DE CAMPO (Reportes de Misión) */}
                <section className="space-y-12">
                    <div className="text-center">
                        <h2 className="text-2xl font-black uppercase tracking-tight font-mono">REPORTES DE MISIÓN_</h2>
                        <p className="text-neutral-500 text-[10px] font-mono uppercase tracking-widest mt-2">Verticales de Éxito (Sin Bullshit)</p>
                    </div>

                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        {[
                            { n: "Salud", res: "+180% en citas confirmadas.", metric: "Sincronización Imed + Resumen Clínico IA" },
                            { n: "Automotriz", res: "Transformación de mercado informal a ecosistema de confianza.", metric: "Certificación de Garantía EaaS" },
                            { n: "Fintech", res: "Maximización de retención en entornos de alta rotación.", metric: "Predicción Algorítmica Operativa" }
                        ].map((m, i) => (
                ...
                {/* 5. LA "CAJA NEGRA" (Soberanía Tecnológica) */}
                <section className="bg-gradient-to-br from-[#0a0a0a] to-[#000] border border-white/[0.05] rounded-2xl p-8 sm:p-16 text-center space-y-10 relative overflow-hidden">
                    ...
                    <div className="relative z-10 space-y-4">
                        ...
                        <strong className="text-mercenario-danger font-mono text-sm uppercase tracking-widest block">Soberanía Tecnológica Absoluta.</strong>
                    </div>
                    ...
                    <p className="text-neutral-300 text-lg font-mono max-w-2xl mx-auto relative z-10 leading-relaxed italic border-l-2 border-mercenario-danger pl-6 text-left">
                        "No somos una agencia de plantillas. Somos ingenieros de infraestructura. Desplegamos Infraestructura como Código (IaC)."
                    </p>
                ...
                {/* 6. LA OFERTA: "OPERACIÓN RECONOCIMIENTO" */}
                <section id="auditoria" className="py-12 border-y border-mercenario-danger/30 bg-mercenario-danger/5 relative">
                    <div className="max-w-3xl mx-auto text-center space-y-8 px-6">
                        <div className="space-y-4">
                            <span className="font-mono text-mercenario-danger font-bold text-[10px] uppercase tracking-[0.2em]">OFERTA LIMITADA: OPERACIÓN RECONOCIMIENTO</span>
                        ...
                        <p className="font-mono text-sm md:text-base text-neutral-300 leading-relaxed">
                            Inicie con una auditoría técnica y una prueba de concepto (PoC) de 21 días por $1.000 USD. Recuperamos su base de datos muerta y demostramos el ROI matemático <strong className="text-white">antes</strong> de construir su Ecosistema 360 completo.
                        </p>
                ...
                {/* EL MANIFIESTO (Consejo Estratégico del Footer) */}
                <section className="text-center max-w-4xl mx-auto pt-10">
                    <h3 className="font-mono text-[10px] text-neutral-600 uppercase tracking-widest mb-6">MANIFIESTO DE INGENIERÍA_</h3>
                    <p className="font-mono text-[11px] sm:text-xs text-neutral-500 leading-relaxed text-justify sm:text-center px-4">
                        Tener el mejor producto del mercado ya no es suficiente. Si su proceso comercial depende exclusivamente del esfuerzo humano, de vendedores que no hacen seguimiento a tiempo, o de campañas que tiran datos crudos a correos electrónicos esperando un milagro... su negocio está diseñado para fallar en el volumen. Un humano se cansa, olvida y procrastina. Una infraestructura autónoma no descansa, no perdona un lead y obedece al algoritmo de rentabilidad absoluta. <strong>Cualquier otra opción en 2026 es un juguete corporativo.</strong> Bienvenidas sean las operaciones autónomas.
                    </p>
                </section>
